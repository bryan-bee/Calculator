...
public class Tokenizer {
    ...
    /**
     * mIndex is an index into mString. It keeps track of the position in the
     * String where we are at as we break the String into tokens.
     */
    private int mIndex;

    /**
     * mString is a String containing an infix expression that is is to be
     * scanned an split into tokens.
     */
    private String mString;

    /**
     * The input parameter is a String containing an infix expression to be
     * split into tokens.
     */
    ...
    /**
     * Returns the next token in the infix expression string being scanned.
     * Employs a simple Finite State Machine
